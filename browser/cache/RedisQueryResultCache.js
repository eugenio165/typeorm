...
var RedisQueryResultCache = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        merged = (_a = Array()).concat.apply(_a, __spreadArray([], __read(allIdentifiers), false));
    ...
    RedisQueryResultCache.prototype.deleteKeys = function (keys) {
        ...
        return new Promise(function (ok, fail) {
            var _a;
            (_a = _this.client).del.apply(_a, __spreadArray(__spreadArray([], __read(keys), false), [function (err, result) {
                    if (err)
                        return fail(err);
                    ok();
                }], false));
